    ...
    public class GEditorSettingsInspector : Editor
    {
        ...
        public void DrawBillboardToolsSettings()
        {
            ...
            GEditorCommon.Foldout(label, false, id, () =>
            {
                ...
                instance.billboardTools.atlasPostProcessMaterial = EditorGUILayout.ObjectField("Atlas Post Process Material", instance.billboardTools.atlasPostProcessMaterial, typeof(Material), false) as Material;
