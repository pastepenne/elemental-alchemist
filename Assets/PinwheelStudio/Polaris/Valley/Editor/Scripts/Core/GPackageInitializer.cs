...
#pragma warning disable 0414
        ...
        //Polaris editions
        public static bool isPolarisSummitInstalled = false;
        public static bool isPolarisHighlandInstalled = false;
...
#pragma warning restore 0414
        ...
        private static void CheckThirdPartyPackages()
        {
            ...
            isPolarisSummitInstalled = false;
            isPolarisHighlandInstalled = false;

#if GRIFFIN
            GRuntimeSettings.isSummitEditionInstalled = false;
            GRuntimeSettings.isHighlandEditionInstalled = false;
#endif
            ...
            for (int i = 0; i < loadedTypes.Count; ++i)
            {
                ...
                //if (t.Name!=null &&
                //    t.Namespace.Equals("UnityEngine.Rendering.Universal"))
                //{
                //    isUrpInstalled = true;
                //}
                ...
                if (t.Name.Equals("PolarisSummit"))
                {
                    isPolarisSummitInstalled = true;
#if GRIFFIN
                    GRuntimeSettings.isSummitEditionInstalled = true;
#endif
                }

                if (t.Name.Equals("PolarisHighland"))
                {
                    isPolarisHighlandInstalled = true;
#if GRIFFIN
                    GRuntimeSettings.isHighlandEditionInstalled = true;
#endif
                }
            }
        }
        ...
        private static void SetupKeywords()
        {
            ...
            isDirty = isDirty || SetKeywordActive(symbolList, GRIFFIN_URP_KW, isUrpSupportInstalled && isUrpInstalled);
            isDirty = isDirty || SetKeywordActive(symbolList, GRIFFIN_VEGETATION_STUDIO_PRO_KW, isVegetationStudioProExtensionInstalled);
            isDirty = isDirty || SetKeywordActive(symbolList, GRIFFIN_BURST_KW, isBurstInstalled && isPolarisSummitInstalled);
