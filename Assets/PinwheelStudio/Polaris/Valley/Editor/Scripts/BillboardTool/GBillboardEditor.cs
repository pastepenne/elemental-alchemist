...
namespace Pinwheel.Griffin.BillboardTool
{
    public class GBillboardEditor : GTwoPaneWindowWindow
    {
        ...
        public Material atlasPostProcessMaterial;
        ...
        private const string KEY_SUPERSAMPLE = "supersampling";
        private const string KEY_ANTIALIASING = "antialiasing";
        ...
        private void SavePrefs()
        {
            ...
            EditorPrefs.SetBool(GEditorCommon.GetProjectRelatedEditorPrefsKey(KEY_BILLBOARDEDITOR, KEY_ANTIALIASING), antiAliasing);
        ...
        private void LoadPrefs()
        {
            ...
            antiAliasing = EditorPrefs.GetBool(GEditorCommon.GetProjectRelatedEditorPrefsKey(KEY_BILLBOARDEDITOR, KEY_ANTIALIASING), false);
            ...
            atlasPostProcessMaterial = GEditorSettings.Instance.billboardTools.atlasPostProcessMaterial;
        ...
        private void CopyArgs(GBillboardCreatorArgs args)
        {
            ...
            atlasPostProcessMaterial = args.AtlasPostProcessMaterial;
        ...
        private void SaveAssets()
        {
            ...
            try
            {
                ...
                atlasImporter.mipMapsPreserveCoverage = true;
                atlasImporter.alphaTestReferenceValue = 0.5f;
