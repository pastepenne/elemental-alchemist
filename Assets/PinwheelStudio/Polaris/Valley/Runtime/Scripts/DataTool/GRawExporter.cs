...
{
    /// <summary>
    /// Utility class to export a raw file from terrain height map.
    /// </summary>
    public class GRawExporter
    {
        ...
        /// <summary>
        /// Export the RAW file to local storage.
        /// </summary>
        ...
        public string Export()
        {
            ...
            try
            {
                ...
                {
                    exportedPath = DoExportRaw8();
                }
                else if (BitDepth == GBitDepth.Bit16)
                {
                    exportedPath = DoExportRaw16();
                }
            }
