...
namespace Pinwheel.Griffin.Physics
{
    /// <summary>
    /// A component that handle collision between tree instances ('foliage' trees) and rigidbodies near a target player.
    /// This component usually created along with your terrain. 
    /// </summary>
    [ExecuteInEditMode]
    public class GTreeCollider : MonoBehaviour
    {
        ...
        /// <summary>
        /// The parent Polaris terrain object.
        /// </summary>
        ...
        /// <summary>
        /// Maximum distance from the target to the tree that supports collision.
        /// </summary>
        ...
        /// <summary>
        /// Enable this to make a tree collider to have the original tree prefab's tag.
        /// This involves string copy.
        /// </summary>
