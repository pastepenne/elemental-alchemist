...
{
    /// <summary>
    /// Utility class for generate grass meshes (quad, cross, tricross, clump) for grass rendering.
    /// Generated mesh are assigned to Runtime Settings and used by the renderer.
    /// If you need custom mesh for those grass shape, modify this class code is needed.
    /// </summary>
