...
namespace Pinwheel.Griffin.PoseidonPreview
{
    public class PMat
    {
        ...
        public static readonly string WAVE_HEIGHTS_GERSTNER_STR = "_GWaveHeights";
        public static readonly int WAVE_HEIGHTS_GERSTNER = Shader.PropertyToID(WAVE_HEIGHTS_GERSTNER_STR);
        public static readonly int WAVE_DIRECTIONS_X_GERSTNER = Shader.PropertyToID("_GWaveDirectionsX");
        public static readonly int WAVE_DIRECTIONS_Z_GERSTNER = Shader.PropertyToID("_GWaveDirectionsZ");
        public static readonly int WAVE_LENGTHS_GERSTNER = Shader.PropertyToID("_GWaveLengths");
        public static readonly int WAVE_SPEEDS_GERSTNER = Shader.PropertyToID("_GWaveSpeeds");
        public static readonly int WAVE_STEEPNESSES_GERSTNER = Shader.PropertyToID("_GWaveSteepnesses");
        ...
        public static readonly string REFLECTION_TEX_STR = "_ReflectionTex";
        public static readonly int REFLECTION_TEX = Shader.PropertyToID(REFLECTION_TEX_STR);
        ...
        public static void SetKeywordEnable(string kw, bool enable)
        {
            try
            {
                if (enable)
                {
                    ...
                    activeMaterial.SetFloat(kw, 1f); //for Shader Graph keyword, matching the keyword state with material inspector
                }
                else
                {
                    activeMaterial.DisableKeyword(kw);
                    activeMaterial.SetFloat(kw, 0f);
                }
            }
            catch (NullReferenceException nullEx)
            {
        ...
        public static bool HasLightAbsorptionFX(Material mat)
        {
            return mat.HasProperty(MAX_DEPTH);
        }

        public static bool HasFoamFX(Material mat)
        {
            return mat.HasProperty(FOAM_COLOR);
        }

        public static bool HasCausticFX(Material mat)
        {
            return mat.HasProperty(CAUSTIC_TEX);
        }

        public static bool HasReflectionFX(Material mat)
        {
            return mat.HasProperty(REFLECTION_TEX);
        }

        public static bool HasRefractionFX(Material mat)
        {
            return mat.HasProperty(REFRACTION_DISTORTION_STRENGTH);
        }

        public static bool HasRipplesFX(Material mat)
        {
            return mat.HasProperty(RIPPLE_HEIGHT);
        }

        public static bool HasWaveFX(Material mat)
        {
            return mat.HasProperty(WAVE_HEIGHT);
        }

        public static bool HasWaveMaskFX(Material mat)
        {
            return mat.HasProperty(WAVE_MASK);
        }
    }
}
#endif