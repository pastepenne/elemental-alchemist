...
{
    [InitializeOnLoad]
    public static class LivePreviewHandler
    {
        ...
        {
            GLivePreviewDrawer.DrawGeometryLivePreviewCallback1 += DrawGeometryLivePreview1;
            GLivePreviewDrawer.DrawGeometryLivePreviewCallback2 += DrawGeometryLivePreview2;
            GLivePreviewDrawer.DrawSubdivLivePreviewCallback += DrawSubdivLivePreview;
            GLivePreviewDrawer.DrawVisibilityLivePreviewCallback1 += DrawVisibilityLivePreview1;
            GLivePreviewDrawer.DrawVisibilityLivePreviewCallback2 += DrawVisibilityLivePreview2;
            GLivePreviewDrawer.DrawAlbedoLivePreviewCallback += DrawAlbedoLivePreview;
            GLivePreviewDrawer.DrawMetallicSmoothnessLivePreviewCallback += DrawMetallicSmoothnessLivePreview;
            GLivePreviewDrawer.DrawAMSLivePreviewCallback1 += DrawAMSLivePreview1;
            GLivePreviewDrawer.DrawAMSLivePreviewCallback2 += DrawAMSLivePreview2;
            GLivePreviewDrawer.DrawSplatLivePreviewCallback1 += DrawSplatLivePreview1;
            GLivePreviewDrawer.DrawSplatLivePreviewCallback2 += DrawSplatLivePreview2;
            GLivePreviewDrawer.DrawMaskLivePreviewCallback1 += DrawMasksLivePreview1;
            GLivePreviewDrawer.DrawMaskLivePreviewCallback2 += DrawMasksLivePreview2;
            GLivePreviewDrawer.DrawMask4ChannelsLivePreviewCallback += DrawMask4ChannelsLivePreview;
        }

        public static void DrawGeometryLivePreview1(GStylizedTerrain t, Camera cam, Texture newHeightMap, Rect dirtyRect)
        {
        ...
        public static void DrawGeometryLivePreview2(GStylizedTerrain t, Camera cam, Texture newHeightMap, bool[] chunkCulling)
        {
            if (t.transform.rotation != Quaternion.identity ||
                t.transform.lossyScale != Vector3.one)
                return;
        ...
        public static void DrawVisibilityLivePreview1(GStylizedTerrain t, Camera cam, Texture newHeightMap, Rect dirtyRect, Texture mask, Matrix4x4 worldPointToMaskMatrix)
        {
            if (t.transform.rotation != Quaternion.identity ||
                t.transform.lossyScale != Vector3.one)
                return;
        ...
        public static void DrawVisibilityLivePreview2(GStylizedTerrain t, Camera cam, Texture newHeightMap, bool[] chunkCulling, Texture mask, Matrix4x4 worldPointToMaskMatrix)
        {
            if (t.transform.rotation != Quaternion.identity ||
                t.transform.lossyScale != Vector3.one)
                return;
        ...
        public static void DrawAMSLivePreview1(GStylizedTerrain t, Camera cam, Texture newAlbedo, Texture newMetallicMap, Rect dirtyRect)
        {
            Material mat = t.TerrainData.Shading.MaterialToRender;
            if (mat == null)
                return;
        ...
        public static void DrawAMSLivePreview2(GStylizedTerrain t, Camera cam, Texture newAlbedo, Texture newMetallicMap, bool[] chunkCulling)
        {
            Material mat = t.TerrainData.Shading.MaterialToRender;
            if (mat == null)
                return;
        ...
        public static void DrawSplatLivePreview1(GStylizedTerrain t, Camera cam, Texture[] newControlMaps, Rect dirtyRect)
        {
            Material mat = t.TerrainData.Shading.MaterialToRender;
            if (mat == null)
                return;
        ...
        public static void DrawSplatLivePreview2(GStylizedTerrain t, Camera cam, Texture[] newControlMaps, bool[] chunkCulling)
        {
            Material mat = t.TerrainData.Shading.MaterialToRender;
            if (mat == null)
                return;
        ...
        public static void DrawMasksLivePreview1(GStylizedTerrain t, Camera cam, Texture[] masks, Color[] colors, Rect dirtyRect, int channel = 0)
        {
        ...
        public static void DrawMasksLivePreview2(GStylizedTerrain t, Camera cam, Texture[] masks, Color[] colors, bool[] chunkCulling, int channel = 0)
        {
            Material mat = GInternalMaterials.MaskVisualizerMaterial;
            if (mat == null)
                return;
