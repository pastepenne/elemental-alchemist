...
{
    /// <summary>
    /// A component that stamps on terrain's texture (albedo, metallic, splat maps).
    /// </summary>
    [System.Serializable]
    [ExecuteInEditMode]
    public class GTextureStamper : MonoBehaviour
    {
        ...
        /// <summary>
        /// The stamp mask, where the R channel will be used.
        /// </summary>
        ...
        /// <summary>
        /// Gradually fade out the stamp mask from its center.
        /// </summary>
        ...
        /// <summary>
        /// The target terrain texture to stamp on.
        /// </summary>
        ...
        /// <summary>
        /// A collection of stamp layers. Layers are applied one after another.
        /// </summary>
        ...
        /// <summary>
        /// Apply the stamp layers. Layers are stamped on the terrain one by one.
        /// </summary>
        public void Apply()
        {
