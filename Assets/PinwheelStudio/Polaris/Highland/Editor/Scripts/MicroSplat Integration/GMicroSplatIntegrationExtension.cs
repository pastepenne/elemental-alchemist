...
namespace Pinwheel.Griffin.MicroSplat.GriffinExtension
{
    public static class GMicroSplatIntegrationExtension
    {
        ...
        public static void OnGUI()
        {
            ...
            {
                Application.OpenURL(GNetUtils.ModURL(GAssetLink.MICRO_SPLAT, "", GAssetLink.UTM_SOURCE, "ms-extension-getms"));
            }
            if (GUILayout.Button("Get Polaris Integration Module"))
            {
                Application.OpenURL(GNetUtils.ModURL(GAssetLink.MICRO_SPLAT_INTEGRATION, "", GAssetLink.UTM_SOURCE, "ms-extension-getmsintegration"));
            }
        }
