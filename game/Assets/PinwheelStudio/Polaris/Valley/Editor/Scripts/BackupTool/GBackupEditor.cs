...
namespace Pinwheel.Griffin.BackupTool
{
    ...
    {
        internal delegate void DrawCreateBackupHandler(GBackupEditor editor);
        internal delegate void DrawAvailableBackupHandler(GBackupEditor editor);

        internal static event DrawCreateBackupHandler DrawCreateBackupCallback;
        internal static event DrawAvailableBackupHandler DrawAvailableBackupCallback;
        ...
        private void OnGUI()
        {
            ...
            DrawCreateBackupCallback?.Invoke(this);
            DrawAvailableBackupCallback?.Invoke(this);
        ...
        internal void ConfirmAndDeleteBackup(string backupName)
        {
        ...
        internal void ConfirmAndRestoreBackup(string backupName)
        {
            if (EditorUtility.DisplayDialog(
                "Confirm",
                "Restore this Backup?\n" +
