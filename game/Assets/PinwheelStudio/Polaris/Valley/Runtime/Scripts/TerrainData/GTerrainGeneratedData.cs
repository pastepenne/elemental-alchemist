...
{
    /// <summary>
    /// An asset type containing all generated surface mesh of a terrain.
    /// Don't instantiate it, the terrain will do that instead.
    /// </summary>
    ...
    public class GTerrainGeneratedData : ScriptableObject, ISerializationCallbackReceiver
    {
        ...
        /// <summary>
        /// The data asset of parent terrain component.
        /// </summary>
        ...
        /// </summary>
        /// <param name="key">The key for mesh query, where XY is the index of that chunk, Z is LOD index.</param>
