...
{
    /// <summary>
    /// Due to the 64k vertex limit of meshes, the terrain will slice its surface into several smaller chunks.
    /// This chunk cover a smaller region of the terrain that contains its own mesh renderer and collider.
    /// The total number of chunks was determined by terrain settings (ChunkGridSize).
    /// </summary>
    [ExecuteInEditMode]
