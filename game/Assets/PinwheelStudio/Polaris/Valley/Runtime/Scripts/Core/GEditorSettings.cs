...
namespace Pinwheel.Griffin
{
    ...
    /// <summary>
    /// Contains Polaris settings in the editor.
    /// </summary>
    public partial class GEditorSettings : ScriptableObject, ISerializationCallbackReceiver
    {
        ...
        /// <summary>
        /// The singleton instance of Polaris editor settings.
        /// </summary>
        ...
        public static event Action SetupSplineLayerCallback;
        private async void SetupLayersAsync()
        {
            await Task.Delay(1000);
            GLayerInitializer.SetupRaycastLayer();
            SetupSplineLayerCallback?.Invoke();
        }
    }
    ...
    public partial class GEditorSettings : ScriptableObject
    {
        ...
        {
            /// <summary>
            /// Allow the editor to display affiliate links to additional assets (tree, grass, textures, etc.) on the Asset Store.
            /// </summary>
            public bool enableAffiliateLinks = true;
            /// <summary>
            /// Allow the terrain to display debug visual in some occasion. Should be off to save drawcalls.
            /// </summary>
            public bool debugMode = false;
            /// <summary>
            /// Turn this on to show terrain's chunk game objects in the hierarchy.
            /// </summary>
