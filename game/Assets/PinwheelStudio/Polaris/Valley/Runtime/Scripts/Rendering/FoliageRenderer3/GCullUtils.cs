...
namespace Pinwheel.Griffin.Rendering
{
    ...
    public static class GCullUtils
    {
        ...
        /// <param name="b"></param>
        /// <returns>Visibility state as listed in the <see cref="GCullFlags"/> struct</returns>
        ...
        /// <param name="p7"></param>
        /// <returns></returns>
        private static bool IsBehindPlaneAABB(ref Plane plane, ref Vector3 p0, ref Vector3 p1, ref Vector3 p2, ref Vector3 p3,
        ...
        /// <summary>
        /// Test if a point is inside camera frustum.
        /// </summary>
        /// <param name="plane0"></param>
        /// <param name="plane1"></param>
        /// <param name="plane2"></param>
        ...
        /// <returns>True if it's inside the frustum.</returns>
