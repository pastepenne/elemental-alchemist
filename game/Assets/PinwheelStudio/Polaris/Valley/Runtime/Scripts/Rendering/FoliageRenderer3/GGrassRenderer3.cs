...
namespace Pinwheel.Griffin.Rendering
{
    ...
    public class GGrassRenderer3
    {
        ...
        internal GStylizedTerrain Terrain
        {
            get { return terrain; }
            private set { terrain = value; }
        }

        internal GGrassRenderer3(GStylizedTerrain terrain)
        {
        ...
        internal void OnCellChanged(int cellIndex)
        {
            if (patchRenderData != null)
            {
                nativeDataPreparationJobsHandle.Complete();
        ...
        internal void DrawDebug(Camera cam)
        {
#if UNITY_EDITOR
            //nativeDataPreparationJobsHandle.Complete();
