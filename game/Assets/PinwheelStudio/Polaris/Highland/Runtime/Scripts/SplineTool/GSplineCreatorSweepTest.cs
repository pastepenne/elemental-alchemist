...
namespace Pinwheel.Griffin.SplineTool
{
    public partial class GSplineCreator : MonoBehaviour
    {
        ...
        /// <param name="width">Width of the inner part of the spline.</param>
        /// <param name="falloffWidth">Width of the outter part of the spline.</param>
        /// <returns>The test results corresponding to each terrain.</returns>
        ...
        /// </summary>
        /// <param name="terrain">The terrain to test against.</param>
        /// <param name="curviness">Number of 'quads' for each spline segment. Higher value means more accurate spline shape.</param>
        /// <param name="width">Width of the inner part of the spline.</param>
        /// <param name="falloffWidth">Width of the outter part of the spline.</param>
        /// <returns>The affected regions, in terrain's UV space.</returns>
        /// 
        /// <seealso cref="GGeometry.SetRegionDirty(IEnumerable{Rect})"/>
        /// <seealso cref="GFoliage.SetTreeRegionDirty(IEnumerable{Rect})(IEnumerable{Rect})"/>
        /// <seealso cref="GFoliage.SetGrassRegionDirty(IEnumerable{Rect})(IEnumerable{Rect})(IEnumerable{Rect})"/>
        /// <seealso cref="GTerrainData.SetDirty(GTerrainData.DirtyFlags)"/>
